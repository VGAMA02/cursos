...
namespace ManejoPresupuesto.Servicios
{
    ...
    public class RepositorioCuentas : IRepositorioCuentas
    {
        ...
        public async Task Crear(Cuenta cuenta)
        {
            ...
            int id = await connection.QuerySingleAsync<int>(@"INSERT INTO Cuentas (Nombre, TipoCuentaId, Descripcion, Balance) VALUES (@Nombre, @TipoCuentaId, @Descripcion, @Balance); SELECT SCOPE_IDENTITY();", cuenta);
            cuenta.Id = id;
        }
